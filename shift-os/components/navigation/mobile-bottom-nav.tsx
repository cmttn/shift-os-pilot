...
interface NavItem {
  href: string;
  label: string;
  icon: 'home' | 'bell' | 'calendar' | 'goals' | 'tickets' | 'players' | 'teams';
  activePaths?: string[];
}
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className="flex min-h-14 flex-col items-center justify-center gap-1 rounded-2xl px-1 text-[10px] font-medium transition-all duration-300 ease-out"
              style={{
