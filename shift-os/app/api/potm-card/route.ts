...
export async function POST(request: Request) {
  ...
  const image = new ImageResponse(
    React.createElement('div', {
      ...
      React.createElement('svg', { key: 'trophy', viewBox: '0 0 180 220', style: { position: 'absolute', right: -96, top: 260, width: 470, height: 574, color: 'rgba(255,255,255,0.035)' } },
      ...
      React.createElement('div', { key: 'content', style: { position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', height: '100%', padding: 62 } }, [
        ...
        React.createElement('div', { key: 'badge-wrap', style: { position: 'absolute', left: 62, top: 142, width: 280, height: 280, display: 'flex', alignItems: 'center', justifyContent: 'center' } },
          club?.badge_url
            ? React.createElement('img', { key: 'badge', src: club.badge_url, width: 280, height: 280, style: { objectFit: 'contain' } })
            : React.createElement('div', { key: 'badge-fallback', style: { width: 260, height: 260, borderRadius: 48, backgroundColor: 'rgba(255,255,255,0.16)', border: '1px solid rgba(255,255,255,0.22)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 76, fontWeight: 900 } }, initials(displayClub))
        ),
        React.createElement('div', { key: 'main', style: { marginTop: 292, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' } }, [
          ...
          React.createElement('div', { key: 'parents', style: { marginTop: 22, border: '1px solid rgba(255,255,255,0.1)', backgroundColor: 'rgba(0,0,0,0.12)', borderRadius: 9999, padding: '8px 14px', fontSize: 15, letterSpacing: 3, fontWeight: 800, textTransform: 'uppercase', color: 'rgba(255,255,255,0.58)' } }, 'Awarded by parents')
        ]),
        React.createElement('div', { key: 'quote', style: { marginTop: 32, border: '1px solid rgba(255,255,255,0.12)', backgroundColor: 'rgba(0,0,0,0.28)', borderRadius: 30, padding: '22px 30px', width: 824 } },
